...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    // tank drive simple
    // left_drive_master.set(-controller.getLeftY());
    // right_drive_master.set(-controller.getRightY());

    // tank drive with DifferentialDrive
    // drivebase.tankDrive(-controller.getLeftY(), -controller.getRightY());

    // arcade drive
    drivebase.arcadeDrive(-controller.getLeftY(), -controller.getRightX());
  }
